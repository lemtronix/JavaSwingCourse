...
public class Controller {
    ...
    public void addPerson(FormEvent formContents)
    {
        db.add(new Person.Builder()
                .name(formContents.getName())
                .occupation(formContents.getOccupation())
                .ageCategory(convertAgeCategoryId(formContents.getAgeCategory()))
                .employementCategory(convertEmployeeCategoryString(formContents.getEmployeeCategory()))
                .taxId(formContents.getTaxId())
                .usCitizen(formContents.isUsCitizen())
                .gender(convertGenderCategoryString(formContents.getGender()))
                .build());
    }
